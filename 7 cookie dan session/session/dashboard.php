	...
	<div class="contariner-fluid bg-primary-subtle d-flex align-items-center justify-content-center" style="height:100vh">
			<div class="card p-3 col-lg-6 m-4" style="border-radius:15px">
				...
				<div class="kiri col-lg-4">
					<img src="4.jpg" class="img-fluid col-12 rounded">
				</div>
				<div class="kanan col-lg-8">
				    <h2 class="fw-bold mb-8"><?= $_SESSION['username']?>viaan</h2>
				    <small>viaan sekolah dan pengajar mapel pilihan.</small>
				    <div class="col-12 py-3">
				    	<small>pengajar jurusan : </small><br>
				    	<span class="badge rounded-pill text-bg-primary">PPG</span>
